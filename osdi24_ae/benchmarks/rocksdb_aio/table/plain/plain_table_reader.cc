...
class PlainTableIterator : public InternalIterator {
 public:
  ...
  // CONFIG_AIO
  void Seek_AIO(const Slice& /*target*/, int /*order*/) override { return; }
...
// CONFIG_AIO
Status PlainTableReader::Get_Topfilter(const ReadOptions& /*ro*/, const Slice& target,
  ...
  return Get(b, target, get_context, nullptr, false);
}
