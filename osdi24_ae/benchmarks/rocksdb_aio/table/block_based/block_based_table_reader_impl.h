...
TBlockIter* BlockBasedTable::NewDataBlockIterator_AIO(
    ...
    FilePrefetchBuffer* prefetch_buffer, bool for_compaction, int order) const {
  ...
  s = RetrieveBlock_AIO(prefetch_buffer, ro, handle, dict, &block, block_type,
                    ...
                    /* use_cache */ true, /* wait_for_cache */ true, PART_INDEX, order);
