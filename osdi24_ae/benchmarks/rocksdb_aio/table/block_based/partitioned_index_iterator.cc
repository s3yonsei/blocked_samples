...
// CONFIG AIO
void PartitionedIndexIterator::Seek_AIO(const Slice& target, int order) { SeekImpl_AIO(&target, order); }

void PartitionedIndexIterator::SeekToFirst() { SeekImpl(nullptr); }

// CONFIG AIO
void PartitionedIndexIterator::SeekImpl_AIO(const Slice* target, int order) {
  SavePrevIndexValue();
  ...
  InitPartitionedIndexBlock_AIO(order);
...
// CONFIG AIO
void PartitionedIndexIterator::InitPartitionedIndexBlock_AIO(int order) {
