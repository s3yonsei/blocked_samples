...
// CONFIG_AIO
IOStatus EncryptedRandomAccessFile::Read_TF_AIO(uint64_t offset, size_t n,
                                         const IOOptions& options,
                                         char* scratch,
...
/*
IOStatus EncryptedRandomAccessFile::Read_PF_AIO(uint64_t offset, size_t n,
                                         const IOOptions& options,
                                         char* scratch,
                                         IODebugContext* dbg) const {
  Slice *result = NULL;
...
IOStatus EncryptedRandomAccessFile::Read_TI_AIO(uint64_t offset, size_t n,
                                         const IOOptions& options,
                                         char* scratch,
                                         IODebugContext* dbg) const {
  Slice *result = NULL;
...
IOStatus EncryptedRandomAccessFile::Read_PI_AIO(uint64_t offset, size_t n,
                                         const IOOptions& options,
                                         char* scratch,
                                         IODebugContext* dbg) const {
  Slice *result = NULL;
