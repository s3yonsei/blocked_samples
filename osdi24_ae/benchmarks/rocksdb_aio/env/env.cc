...
// CONFIG_AIO
  IOStatus Read_TF_AIO(uint64_t offset, size_t n, const IOOptions& ,
                        char* scratch,
...
/*
  IOStatus Read_PF_AIO(uint64_t offset, size_t n, const IOOptions& ,
                        char* scratch,
                        IODebugContext* *//*dbg*//*) const override{
	  Slice* result = NULL;
    return status_to_io_status(target_->Read(offset, n, result, scratch));
...
*/
/* 
  IOStatus Read_TI_AIO(uint64_t offset, size_t n, const IOOptions& ,
                        char* scratch,
                        IODebugContext* *//*dbg*//*) const override{
	  Slice* result = NULL;
    return status_to_io_status(target_->Read(offset, n, result, scratch));
...
*/
/*  
  IOStatus Read_PI_AIO(uint64_t offset, size_t n, const IOOptions& ,
                        char* scratch,
                        IODebugContext* *//*dbg*//*) const override{
	  Slice* result = NULL;
    return status_to_io_status(target_->Read(offset, n, result, scratch));
