...
// CONFIG_AIO
  IOStatus Read_TF_AIO(uint64_t offset, size_t n, const IOOptions& opts,
                        char* scratch,
                        IODebugContext* dbg) const override; 

/*  IOStatus Read_PF_AIO(uint64_t offset, size_t n, const IOOptions& opts,
                        char* scratch,
                        IODebugContext* dbg) const override; 

  IOStatus Read_TI_AIO(uint64_t offset, size_t n, const IOOptions& opts,
                        char* scratch,
                        IODebugContext* dbg) const override; 

  IOStatus Read_PI_AIO(uint64_t offset, size_t n, const IOOptions& opts,
                        char* scratch,
                        IODebugContext* dbg) const override;
*/  
