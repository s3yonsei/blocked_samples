...
class ReadaheadRandomAccessFile : public FSRandomAccessFile {
 public:
  ...
  ReadaheadRandomAccessFile& operator=(const ReadaheadRandomAccessFile&) =
      delete;
// CONFIG_AIO
  IOStatus Read_TF_AIO(uint64_t offset, size_t n, const IOOptions& options,
                char* scratch,
...
/*
  IOStatus Read_PF_AIO(uint64_t offset, size_t n, const IOOptions& options,
                char* scratch,
                IODebugContext* dbg) const override {
	  Slice *result=NULL;
    // Read-ahead only make sense if we have some slack left after reading
  ...
  IOStatus Read_TI_AIO(uint64_t offset, size_t n, const IOOptions& options,
                char* scratch,
                IODebugContext* dbg) const override {
	  Slice *result=NULL;
    // Read-ahead only make sense if we have some slack left after reading
  ...
  IOStatus Read_PI_AIO(uint64_t offset, size_t n, const IOOptions& options,
                char* scratch,
                IODebugContext* dbg) const override {
	  Slice *result=NULL;
    // Read-ahead only make sense if we have some slack left after reading
