...
do
	...
	do
		echo "Subclass-level virtual speedup, # cores=1, ${i}th iter"
		sleep 2
...
do
	for((speedup=0;speedup<=100;speedup+=10))
	do
		echo "Subclass-level virtual speedup, # cores=2, ${i}th iter"
		sleep 2
...
do
	for((speedup=0;speedup<=100;speedup+=10))
	do
		echo "Subclass-level virtual speedup, # cores=4, ${i}th iter"
		sleep 2
...
do
	for((speedup=0;speedup<=100;speedup+=10))
	do
		echo "Subclass-level virtual speedup, # cores=8, ${i}th iter"
		sleep 2
...
do
	for((speedup=0;speedup<=100;speedup+=10))
	do
		echo "Subclass-level virtual speedup, # cores=16, ${i}th iter"
		sleep 2
...
do
	for((speedup=0;speedup<=100;speedup+=10))
	do
		echo "Subclass-level virtual speedup, # cores=32, ${i}th iter"
		sleep 2
