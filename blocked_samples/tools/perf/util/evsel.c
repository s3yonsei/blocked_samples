			     ...
			     struct perf_sample *data)
{
	...
	if (event->header.misc & PERF_RECORD_MISC_IOWAIT) {
		data->cpumode -= PERF_RECORD_MISC_IOWAIT;
		data->misc -= PERF_RECORD_MISC_IOWAIT;
		data->blocked = PERF_RECORD_MISC_IOWAIT;
	} else if (event->header.misc & PERF_RECORD_MISC_SCHED) {
		data->cpumode -= PERF_RECORD_MISC_SCHED;
		data->misc -= PERF_RECORD_MISC_SCHED;
		data->blocked = PERF_RECORD_MISC_SCHED;
	} else if (event->header.misc & PERF_RECORD_MISC_LOCKWAIT) {
		data->cpumode -= PERF_RECORD_MISC_LOCKWAIT;
		data->misc -= PERF_RECORD_MISC_LOCKWAIT;
		data->blocked = PERF_RECORD_MISC_LOCKWAIT;
	} else if (event->header.misc & PERF_RECORD_MISC_BLOCKED) {
		data->cpumode -= PERF_RECORD_MISC_BLOCKED;
		data->misc -= PERF_RECORD_MISC_BLOCKED;
		data->blocked = PERF_RECORD_MISC_BLOCKED;
	}
