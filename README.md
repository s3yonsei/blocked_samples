...
![Example bperf sampling](https://github.com/s3yonsei/blocked_samples/blob/main/osdi24_ae/benchmarks/simple_test/example_results/example-bperf.PNG){: width="50%"}
...
![Example bperf sampling](https://github.com/s3yonsei/blocked_samples/blob/main/osdi24_ae/benchmarks/simple_test/example_results/example-bcoz.PNG){: width="95%"}
