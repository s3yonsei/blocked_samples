...
## News
**[08/2025]** We're working on patching our blocked samples feature into the Linux kernel mainline. We have already ported the feature to a newer a newer Linux kernel (6.17.0-rc2), which you can try [here](https://github.com/s3yonsei/linux-blocked_samples).
